    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10765&lang=1&conf=" + response;
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10765&lang=1&conf=" + response + "&lastname=" + $("#lastname3").val();
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10765&lang=1&conf=" + response + "&lastname=" + $("#lastname2").val();
            }
        }
    });
    return false;
...
ageOption+='<option value="12">12</option>';
    ...
    function parse_rates(xml) {   
        ...
        $.ajax({
            type: "GET",            
            async: false,
            url: "/hotel_fastlink_js/10765.xml",
            dataType: "xml",
                        ...
                        if (check_the_date(curL, unavail_v2)){
                            ...
                            if (+cur === +_selected_date) {
                                ...
                                if (stopDate!=curDate.getTime()) {
                                    if (firstTime >= 0){
$('#error_message_content').empty().append('<p class="center a95f5f">Your selection is unavailable. Please choose another date or call +52 998 8815500 for possible limited inventory.</p>');
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10757&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HYATT ZIVA CANCUN</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10757&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HYATT ZIVA CANCUN</p></a>';
