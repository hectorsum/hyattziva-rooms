    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10757&lang=1&conf=" + response;
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10757&lang=1&conf=" + response + "&lastname=" + $("#lastname3").val();
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10757&lang=1&conf=" + response + "&lastname=" + $("#lastname2").val();
            }
        }
    });
    return false;
...
var cur_conv = 1;
    ...
    if ($('.mobile-see-more-rooms').length > 0 && $('.hotel-list-box').length > 0) {
        $('.mobile-see-more-rooms').on('click', function(){
            ...
            $('#error_message_content').empty().append('<p class="center a95f5f">Oops, Sorry an error has occurred.</p>');
            $.fancybox({
                href: '#error-pop-up',
                fitToView  : false,
                autoSize: true,
    ...
    $('#next-step').on('click', function(event){
        ...
        var ageBox='';
        var ageOption='';
        var today = new Date(2021,3,26);
        var aD = new Date(2021,4,31);
...
ageOption+='<option value="12">12</option>';
    ...
    function parse_rates(xml) {   
        ...
        $.ajax({
            type: "GET",            
            async: false,
            url: "/hotel_fastlink_js/10757.xml",
            dataType: "xml",
            ...
            error: function(res, textStatus, errorThrown){
                get_data('30-APR-21','31-OCT-21', textStatus + errorThrown.substring(0, 20));
            }
        });  */

        
        if(typeof CAL_XML === "undefined"){
            get_data('30-APR-21','31-OCT-21', "File Not Found");
        } else {
            try{
        ...
        $.ajax({
            ...
            data: {
                ...
                xStartDate: startDate?startDate:'26-APR-21',
                xEndDate: endDate?endDate:'31-MAY-21',
                xAdults: '2',
                xChild: '0',
                xInfants: '0',
                xRooms: '1',
    ...
    if ($('.travel-calendar').length > 0) {
        ...
        var temp1 = new Date(2021,4,31);
        var temp2 = new Date(2021,5,20);
var temp3 = new Date();

        var temp4 = new Date(2021,5,26);
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10765&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PANAMA JACK CANCUN RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10766&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PANAMA JACK RESORTS PLAYA DEL CARMEN</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10758&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HYATT ZILARA CANCUN</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10769&aDate='+$( "#aDate" ).val()+'&dDate='+$( "#dDate" ).val()+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HILTON PLAYA DEL CARMEN ADULT RESORT</p></a>';
...
$('#suggest_hotels_content').append(resp);
    ...
    if ($('#long-range-datepicker').length > 0) {
        ...
        $(document).on('click', '.ui-datepicker-unselectable', function(e){
            ...
            if (firstTime > 0){
$('#error_message_content').empty().append('<p class="center a95f5f">Your selection is unavailable. Please choose another date or call +1 998 8487000 for possible limited inventory.</p>');
}
 var OK = false;  
                                            var show = false;
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10765&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PANAMA JACK CANCUN RESORT</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10766&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">PANAMA JACK RESORTS PLAYA DEL CARMEN</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10758&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HYATT ZILARA CANCUN</p></a>';
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(xml1){      
                                                    $( xml1 ).find('RS').each(function(){
                                                        ...
                                                        if (OK == true){
                                                            show = true;
                                                            resp += '<a class="suggest_available" style="color: white;" href="ibe5.main?hotel=10769&aDate='+adate+'&dDate='+edate+'&showcalendar=Y"><p class="center compare-btn" id="error-pop-up-msg" style="font-weight: bold;  background: #00529c;display: block; padding: 7px; text-align: center; border-radius: 3px;">HILTON PLAYA DEL CARMEN ADULT RESORT</p></a>';
